...
impl LsmStorageInner {
        ...
        if !manifest_path.exists() {
            ...
            for record in records {
                match record {
                    ...
                    crate::manifest::ManifestRecord::NewMemtable(_) => todo!(),
                    crate::manifest::ManifestRecord::Compaction(compaction_task, output) => {
    ...
    pub fn scan(
        ...
        snapshot
            .imm_memtables
            .iter()
            .for_each(|m| memtable_iters.push(Box::new(m.scan(lower, upper))));
        ...
        let iter = FusedIterator::new(LsmIterator::new(iter, map_bound(upper))?);
